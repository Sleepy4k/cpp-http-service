...
namespace http {
  class TCPServer {
    ...
    private:
      ...
      std::string buildDefaultResponseMessage() {
        std::string html = "<html><head><title>HTTP Service</title></head><body><h1>This is server response</h1><p>Status: Server is running.</p></body></html>";
